  ...
  class ConfigurationImporter
    class UnmanagedDetector # rubocop:disable Metrics/ClassLength
      ...
      MANAGED_ENV_KEYS = %w[
        ...
        WATCHTOWER_POLL_INTERVAL WATCHTOWER_SCHEDULE WATCHTOWER_SCOPE WATCHTOWER_CLEANUP
        POSTGRES_PASSWORD
        ...
        PVNODE_SITE_ID PVNODE_APIKEY PVNODE_PAID PVNODE_REQUEST_LIMIT PVNODE_EXTRA_PARAMS
